...
report1.photo.attach(io: photo_report1, filename: 'pothole.jpg', content_type: 'image/jpg')
report1.save
...
report2.photo.attach(io: photo_report2, filename: 'litter_central_park.jpg', content_type: 'image/jpg')
report2.save
...
report3.photo.attach(io: photo_report3, filename: 'graffiti_elm_st.jpg', content_type: 'image/jpg')
report3.save
...
report4.photo.attach(io: photo_report4, filename: 'town_hall_area.jpg', content_type: 'image/jpg')
report4.save
...
report5.photo.attach(io: photo_report5, filename: 'broken_bench_park.jpg', content_type: 'image/jpg')
report5.save
...
report6.photo.attach(io: photo_report6, filename: 'faded_crosswalk.jpg', content_type: 'image/jpg')
report6.save
...
report7.photo.attach(io: photo_report7, filename: 'poor_lighting_oak_st.jpg', content_type: 'image/jpg')
report7.save

photo_report8 = URI.open('https://link-to-example-image-8.com')
...
report8.photo.attach(io: photo_report8, filename: 'overgrown_bushes_park.jpg', content_type: 'image/jpg')
report8.save
